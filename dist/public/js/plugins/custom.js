    ...
    `);
                ...
                item(globalClasses, data, removeItemButton) {
                    ...
                    if (removeItemButton) {
                        ...
                        return template(`<div
                                             class="${globalClasses.item} ${dataHighlighted} ${itemSelectable} ${placeholder}"
                                             data-item
                                             data-id="${data.id}"
                                             data-value="${data.value}"
